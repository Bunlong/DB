...
public class JDBCExample {
	...
	static final String STUDENTS_DB_URL = "jdbc:mysql://localhost/STUDENTS";
	...
	public void selectRecordsWithWhere() {
		Connection conn = null;
		Statement stmt = null;
		try {
			//STEP 2: Register JDBC driver
		...
		System.out.println("Goodbye!");
	}//end selectRecordsWithWhere
	
	public void selectRecordsWithLike() {
		Connection conn = null;
		Statement stmt = null;
		try {
			//STEP 2: Register JDBC driver
